...
**Note: This document describes _building_ Clear Crab _from source_.
This is _not recommended_ if you don't know what you're doing.
If you just want to install Clear Crab, check out the [README.md](README.md) instead.**
...
3. Start a MINGW64 or MINGW32 shell (depending on whether you want 32-bit
   or 64-bit Clear Crab) either from your start menu, or by running `mingw64.exe`
...
5. Navigate to Clear Crab's source code (or clone it), then build it:
